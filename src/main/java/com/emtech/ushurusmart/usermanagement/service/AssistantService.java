...
public class AssistantService {
    ...
    public ResponseEntity<ResContructor> loginAssistant(@NotNull LoginRequest loginReq, ResContructor res)
            throws Exception {
        try {
            ...
            Authentication authentication = authenticationManager
                    .authenticate(new UsernamePasswordAuthenticationToken(loginReq.getEmail(),
                            ...
                            assistant.getAuthorities() != null ? assistant.getAuthorities() : Collections.emptyList()));
            otpService.sendOTP(assistant.getPhoneNumber(), assistant.getName(), assistant.getEmail());
            res.setMessage("A short code has been sent to your email for verification");
    ...
    public String createEmailBody(String name, String ownerName, String email, String password) {
        return "<!DOCTYPE html>\n" +
                ...
                "            <p>Dear " + name + ",</p>\n" +
                "            <p> You have been registered by " + ownerName
                + " to Ushuru Smart.  We are excited to have you on Ushuru Smart! To get started, please use the following  email and  password to log in to your account:</p>\n"
                +
