...
import com.emtech.ushurusmart.Transaction.service.InvoiceService;
...
import com.emtech.ushurusmart.Transaction.Dto.TransactionRequest;
import com.emtech.ushurusmart.Transaction.service.TaxCalculator;
...
public class TransactionController {
    ...
    public ResponseEntity makeTransaction(@RequestBody TransactionRequest request) {
        try {
            double tax = taxCalculatorService.calculateTax(request.getType(), request.getAmount());
            return ResponseEntity.ok()
                    .body("Transaction of type '" + request.getType() + " with tax "
                            + tax + " of value" + request.getAmount() + " processed.");
